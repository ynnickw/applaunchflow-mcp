...
- prepare_screenshot_styles returns the interactive V1/V2 picker in the same tool result. Stop after calling it and let the user choose; do not call apply_screenshot_style yourself. To revisit prepared options or if the host cannot display the widget, provide the exact galleryUrl from the previous result. Do not regenerate styles just to reopen the picker.
...
- prepare_social_graphics_styles returns the interactive picker in the same tool result. Stop after calling it and let the user choose; do not call apply_social_graphics_style yourself. To revisit prepared options or if the host cannot display the widget, provide the exact galleryUrl from the previous result. Do not regenerate styles just to reopen the picker.
...
- generate_promo_video returns all three concepts in the interactive picker in the same tool result. Stop after calling it and let the user choose; do not call apply_promo_video_candidate yourself. To revisit prepared candidates or if the host cannot display the widget, provide the exact pickerUrl from the previous result. Do not generate new candidates just to reopen the picker.
